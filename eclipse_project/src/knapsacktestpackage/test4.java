...
public class test4 {
	...
	public static void solveModel() {
		try {
			...
			//constraint 
			constraints.add(cplex.addGe(cplex.sum(cplex.prod(60, x),cplex.prod(60, y),cplex.prod(60, z),cplex.prod(70, a),cplex.prod(65, b)), 300));
			constraints.add(cplex.addGe(cplex.sum(cplex.prod(12, x),cplex.prod(6, y),cplex.prod(10, z),cplex.prod(9, a),cplex.prod(10, b)), 36));
			constraints.add(cplex.addGe(cplex.sum(cplex.prod(10, x),cplex.prod(30, y),cplex.prod(35, z),cplex.prod(35, a),cplex.prod(40, b)), 90));
